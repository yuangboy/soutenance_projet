    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
                 <a href="/ajouterAssurance" class="btn">
                    <h5 class="card-title">Ajouter Assurance</h5>
                </a>

              <!-- Dark Table -->
              <table class="table table-whith">
                <thead>
                  <tr>
                    <th scope="col">id</th>
                    <th scope="col">Libelle Assurance</th>
                    <th scope="col">Nom assuré</th>
                    <th scope="col">Prénom assuré</th>
                    <th scope="col">Numéro Assurance</th>
                    <th scope="col">Taux paye</th>
                    <th scope="col">Nom bénéficiare assurance</th>
                  </tr>
                </thead>
                <tbody>
                        @foreach ($assurances as $assurances)
                            <tr>
                                <td>{{$assurances->id}}</td>
                                <td>{{$assurances->nomAssure}}</td>
                                <td>{{$assurances->prenomAssure}}</td>
                                <td>{{$assurances->numAss}}</td>
                                <td>{{$assurances->libelle}}</td>
                                <td>{{$assurances->tauxPaye}}</td>
                                <td>{{$assurances->beneficiaier}}</td>

                                <td>
                                    <a href="/updateAssurance-assurances/{{ $assurances->id}}" class="btn btn-info" ><img src="{{ asset('assets/img/modif.png')}} " width="20px" height="20px" alt=""></a>
                                    <a href="/delete-assurance/{{ $assurances->id}}" class="btn btn-danger"><img src="{{ asset('assets/img/supp.png')}} " width="20px" height="20px" alt=""></a>
                                </td>
                            </tr>
                        @endforeach
