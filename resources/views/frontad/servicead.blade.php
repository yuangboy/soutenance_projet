...
<body>
 ...
 <header id="header" class="header fixed-top d-flex align-items-center">
                        ...
                        <tbody>
                                ...
                                @foreach ($service as $services)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/update-services/{{ $services->id}}" class="btn btn-info" ><img src="{{ asset('assets/img/modif.png')}} " width="20px" height="20px" alt=""></a>
                                                    <a href="/delete-service/{{ $services->id}}" class="btn btn-danger"><img src="{{ asset('assets/img/supp.png')}} " width="20px" height="20px" alt=""></a>
                                                </td>
                                            </tr>
                                    @endforeach
                        </tbody>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Hôpital <strong><span>Général</span></strong> Djiri
    </div>
    <div class="credits">
