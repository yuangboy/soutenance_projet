        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Liste des utilisateurs de la plateforme</h5>
                                ...
                                @foreach($users as $user)
                                    <tr>
                                        ...
                                        <form action="{{ route('admin.users.assignRole') }}" method="POST">
                                            ...
                                            <td>{{ $user->statut }}</td>
                                            <td><button type="submit">Attribuer Rôle</button> <br><br>
                                            <!--<a href="/create">Ajouter information du praticien</a></td>-->
                                        </form>
                                        </tr>
                                    @endforeach
