							...
							<div class="col-lg-7 col-md-9 col-12">
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											<li class="active"><a href="#">Mon profil <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
													<li><a href="index.html">Patients</a></li>
												</ul>
											</li>
											<li><a href="/listepraticiensP">Rendez-vous </a></li>
											<li><a href="/listeservicep">Emplois du temps </a></li>

											<li><a href="#">traitement patient <i class="icofont-rounded-down"></i></a>
												<ul class="dropdown">
													<li><a href="blog-single.html">traitement patient</a></li>
												</ul>
											</li>
					...
					<div class="row">
						<div class="col-lg-3 col-md-6 col-12">
							<div class="single-footer">
								...
								<p>VisonCon est une application web qui vous permet de programmer en ligne des rendez vous pour le consultations avec les
                                    praticiens de votre choix, vous faire consulter n'importe où et acederz à votre dossier médicales sécurisé
                                    n'importe où.</p>
								<!-- Social -->
								<ul class="social">
								...
								<div class="row">
									...
									<div class="col-lg-6 col-md-6 col-12">
										<ul>
											...
											<li><a href="#"><i class="fa fa-caret-right" aria-hidden="true"></i>Conracts</a></li>
										</ul>
									</div>
								</div>
							</div>
