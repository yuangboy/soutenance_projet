    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Liste des services de l'hopital</h5>

                    <table class="table">
                        <thead>
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <i class="bi bi-star me-1"></i>
                                         <a href="/ajouter" class = "btn btn-primary">Ajouter un service</a>
                        ...
                        <tbody>
                                ...
                                @foreach ($service as $services)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/update-services/{{ $services->id}}" class="btn btn-info" ><img src="{{ asset('assets/img/modif.png')}} " width="20px" height="20px" alt=""></a><br><br>
                                                    <a href="/delete-service/{{ $services->id}}" class="btn btn-danger"><img src="{{ asset('assets/img/sup2.jpeg')}} " width="30px" height="30px" alt=""></a>
                                                </td>
                                            </tr>
                                    @endforeach
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">liste des praticiens par service</h5>
                ...
                <table class="table">
                        <thead>
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <i class="bi bi-star me-1"></i>
                                         <a href="/ajouter" class = "btn btn-primary">Ajouter un praticiens à un service</a>
                                    <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                </div>
                            <tr>
                                <th>Id Service</th>
                                <th>Libelle service</th>
                                <th>Nom praticens du service</th>
                            </tr>
                        </thead>
                        <tbody>
                                            <tr>
