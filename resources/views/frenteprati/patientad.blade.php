      ...
      <div class="row align-items-top">
        <div class="col-lg-6">
         ...
         <!-- End Default Card -->
          ...
          <div class="card">
            <div class="card-header">Liste de tous les patients de l'HhGD</div>
            <div class="card-body">
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            ...
            <div class="card-img-overlay">
              <h5 class="card-title">Liste des assurés</h5>
              <p class="card-text"></p>
              <table class="table">
                        <thead>
                                <div class="alert alert-primary alert-dismissible fade show" role="alert">
                                    <i class="bi bi-star me-1"></i>
                                         <a href="/ajouterp" class = "btn btn-primary">Ajouter un service</a>
                            ...
                            <tr>
                                ...
                                <th>Noms d'assurés</th>
                            </tr>
                        </thead>
                        <tbody>
                                @foreach ($patienta as $frontad)
                                            <tr>
                                                <td>{{$frontad->id}}</td>
                                                <td>{{$frontad->NumAss}}</td>
                                                <td>{{$frontad->libelle}}</td>
                                                <td>{{$frontad->tauxPaye}}</td>
                                                <td>{{$frontad->NomAssure}}</td>
                                            </tr>
                                    @endforeach
                        </tbody>
                </table>
